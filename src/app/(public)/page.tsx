...
/* ─── Mock Data ─── */
const FEATURED_SCREENS = [
  {
    id: "1",
    name: "Espectacular Blvd. Juárez",
    city: "Mexicali",
    zone: "Zona Centro",
    format: "Espectacular",
    status: "Disponible",
    dims: "12x4m",
    traffic: "50,000 vehículos/día",
    priceMin: "$12,000",
    priceMax: "$15,000",
  ...
  {
    id: "2",
    name: "Pantalla Digital Galerías",
    city: "Tijuana",
    zone: "Zona Río",
    format: "Pantalla digital",
    status: "Disponible",
    dims: "4x3m",
      ...
      <section className="relative pt-28 pb-24 md:pt-40 md:pb-32">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            >
              {[
                { value: "50+", label: "Pantallas activas" },
      ...
      <section className="py-24 md:py-32">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            {FEATURED_SCREENS.map((screen, i) => (
              <motion.div
                key={screen.id}
                variants={fadeInUp}
                transition={{ duration: 0.5 }}
              >
                <Link href="/buscar" className="group block">
                  <div className="rounded-2xl border border-border bg-card shadow-[var(--shadow-card)] hover:shadow-[var(--shadow-card-hover)] transition-all duration-300 hover:-translate-y-1 overflow-hidden">
                    {/* Gradient image area */}
                    <div
                      className={"relative h-48 bg-gradient-to-br " + screen.gradient}
                    >
                      {/* Decorative shapes */}
